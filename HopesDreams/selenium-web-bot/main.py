...
def main():
    ...
    driver = setupDriver()
    driver.get('https://fuckered.w3spaces.com/index.html')
    ...
    for index, row in df.iterrows():
        ...
        # Handles varification of items in drop down box against what was entered into search bar
...
#        haltStep()
        ...
        # selects matching item in drop down menu 
...
#        haltStep()
        ...
        # probably not needed but can be used if a purpose is determined
...
#        haltStep()
        ...
        # will need to be changed to handle appropriate data
